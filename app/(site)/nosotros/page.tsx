...
export default function NosotrosPage() {
  return (
    <div data-screen-label="Nosotros">
      ...
      <section style={{ background: "var(--surface-inverse)", color: "var(--text-inverse)", padding: "60px 20px" }}>
        <div className="wrap wrap--narrow center" style={{ padding: 0 }}>
          <h2 style={{ color: "var(--white)", fontSize: "clamp(22px,3vw,28px)", margin: "0 0 14px" }}>¿Sos arquitecto, diseñador o profesional?</h2>
