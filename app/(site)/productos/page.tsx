...
export const metadata: Metadata = {
  ...
  description: "Paneles ranurados, mobiliario comercial, decoración y más. Elegí entre los productos listos para pedir o pedinos uno a medida.",
  // Los filtros (?categoria=, ?q=…) no son páginas distintas para Google.
