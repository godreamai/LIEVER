// Lucide (ISC) line icons — 1.5px stroke, currentColor.
const PATHS: Record<string, string> = {
  ...
  frame: '<rect width="18" height="18" x="3" y="3" rx="2"></rect><path d="M3 9h18"></path><path d="M9 21V9"></path>',
  ...
  table: '<rect width="18" height="12" x="3" y="4" rx="2"></rect><path d="M7 16v4"></path><path d="M17 16v4"></path>',
...
export function Icon({ name, size = 18, strokeWidth = 1.5, color = "currentColor", style }: IconProps) {
  const d = PATHS[name];
  if (!d) return null;
  return (
    <svg
